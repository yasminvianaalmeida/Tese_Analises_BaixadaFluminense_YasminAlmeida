...
OCC=json.load(open("ocorrencias.json"))
AF=json.load(open("analise_final.json"))
AP=json.load(open("anexo_params.json"))
...
json.dump(out,open("resultados_v2.json","w"),ensure_ascii=False,indent=2)
json.dump(occ,open("ocorrencias_v2.json","w"),ensure_ascii=False,indent=2)
